...
import { Search, BookOpen, Video, Link as LinkIcon, FileUp, ExternalLink, Map } from "lucide-react";
...
export default function ResourcesPage() {
  ...
  useEffect(() => {
    if (typed >= TYPED_TEXT.length) {
      const t = setTimeout(() => setShowRest(true), PAUSE_BEFORE_PARAGRAPH_MS);
  ...
  return (
    <div>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 px-6 lg:px-8 grain overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="backdrop-blur-md bg-black/35 border border-cream/10 rounded-3xl px-8 py-10 sm:px-10 sm:py-12">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-[0.02em] leading-tight mb-6" style={{ fontFamily: "var(--font-display)" }}>
            ...
            <div className={`transition-opacity duration-700 ${showRest ? "opacity-100" : "opacity-0"}`}>
              <p className="text-2xl text-cream/85 max-w-2xl leading-relaxed mb-10">
      ...
      <section id="finlearn-roadmap" className="py-12 px-6 lg:px-8 relative mesh-crimson grain overflow-hidden">
  ...
  <div className="relative z-10">
    <div className="badge-pill badge-crimson mx-auto mb-6">Learning Roadmap</div>
    <h2
